...
print color.yellow+"DedGeo: " + color.reset + "Siendo sincero mi programa no tubiera vida si no fuera por: http://ip-api.com/json/ muchas gracias!\n"

print color.ble+"Created by: " + color.yellow+"DedShellcode"+color.reset+"\n"
...
print "|_____/ \___|\__,_|\_____|\___|\___/ "                                     
print "-------------By-DedShellcode---------"
